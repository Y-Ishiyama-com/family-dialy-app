...
1. 短く、20文字程度の1文で表現できる内容
2. 日記を書く際のきっかけになるような質問形式が理想的
3. 過去のお題で使われている単語を避け、異なる観点や違うテーマを提供する
4. 季節や記念日が提供されている場合、それと関連したお題を検討する

【出力形式】
お題テキストのみを返してください（説明は不要）。"""

    user_message = f"""{context_text}{anniversary_text}{recent_prompts_text}
